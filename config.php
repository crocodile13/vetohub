<?php
/**
 * Configuration centrale de VetoHub
 */
...
/**
 * Retourne la PREMIÈRE URL EXISTANTE avec BASE_URL
 */
function getIcon($key) {
    ...
    // Parcourt tous les chemins et retourne le premier qui existe
    foreach ($iconPaths as $iconPath) {
        $fullPath = __DIR__ . '/' . ltrim($iconPath, '/');
