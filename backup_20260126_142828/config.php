...
// ========================================
// CHEMINS ABSOLUS (CRITIQUE POUR NGINX)
// ========================================
define('BASE_PATH', __DIR__); // Chemin système absolu (/var/www/vetohub)
define('BASE_URL', '/');      // URL relative pour le navigateur
...
function getIcon($key) {
    ...
    foreach ($iconPaths as $iconPath) {
        // MODIFIÉ : utilise BASE_PATH au lieu de __DIR__
        if (file_exists(BASE_PATH . '/' . ltrim($iconPath, '/'))) {
